...
**Total: 90.5 ed at plan-time** (R1 22.5, R2 26, R3 30, R4 12); **83 ed remaining** after B-02, B-20 (1.5 ed), B-01 (3 ed) shipped 2026-08-06 and B-03 (2 ed), the booking-request approval UI (~1 ed) shipped 2026-09-05. At one engineer that is roughly 18 calendar weeks of pure build; budget 24 to 28 with review, migrations and the browser walkthroughs this stack demonstrably needs.
