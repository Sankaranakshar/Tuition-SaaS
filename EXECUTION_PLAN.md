...
**Step 27 (B-17, outbound comms router) is now in progress**, picked up immediately after Step 26 closed for real (below). Read Step 27's full write-up further down this file before touching code.
...
| 27 | B-17 outbound comms router | R3 | Unblocked by D-10, in progress |
