...
| 26 | C-02 wire the scheduler | R3 | ✅ Complete 2026-09-23 (GET/POST bug found + fixed; see "Start here") |
| 27 | B-17 outbound comms router | R3 | Unblocked by D-10, not started |
...
**Status: code and tests complete; deployed to production 2026-09-23 (commit `3891d3e`/`60467a5`, `main`).** The GET/POST mismatch that silently broke every unattended firing since 2026-09-14 is fixed. Still unconfirmed: an actual successful unattended invocation (tonight's window, or a manual dashboard "Run"). Full detail in HANDOFF.md's 2026-09-23 entry.
