...
**Gates, all re-run and green on 2026-09-05 (Step 13 R1 gate checkpoint, off `r1-step-10-dpdp-consent-erasure`):**
...
| API bundle | `npm run build:api && npm run check:api-bundle` | all 16 route mounts present; `api/index.js` rebuilt byte-identical to the committed copy |
