...
_Last verified 2026-09-05 against commit `22fbf19` plus an uncommitted pass closing MASTER_PLAN.md's R1 items B-09 (bulk import) and B-05 (self-serve parent top-up), EXECUTION_PLAN.md Steps 6-7. Every number below was re-run, not inherited._
